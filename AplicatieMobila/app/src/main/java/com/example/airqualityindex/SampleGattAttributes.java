...
public class SampleGattAttributes {
    ...
    //Battery level
    public static final String UUID_BATTERY_SERVICE = "0000180f-0000-1000-8000-00805f9b34fb"; // service
    public static final String UUID_BATTERY_LEVEL_UUID = "00002a19-0000-1000-8000-00805f9b34fb"; //characteristic
    //CELE 2 de mai JOS
